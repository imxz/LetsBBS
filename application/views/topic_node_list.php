            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><a href="<?php echo base_url();?>">首页</a> / <a href="<?php echo base_url('node/'.$nid);?>"><?php echo $site_title;?></a><a class="pull-right" href="<?php echo $follow_link;?>"><?php echo $follow_status;?></a></h3>
                    </div>
