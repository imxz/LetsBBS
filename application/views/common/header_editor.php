...
<head>
    ...
    <!-- 样式文件 -->
    <link rel="stylesheet" href="<?php echo base_url('static/editor/themes/default/css/umeditor.css');?>">
    <!-- 引用jquery -->
    ...
    <!-- 编辑器源码文件 -->
    <script type="text/javascript" src="<?php echo base_url('static/editor/umeditor.js');?>"></script>
    <!-- 语言包文件 -->
