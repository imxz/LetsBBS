            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo form_open('admin/topic/edit/'.$topic['tid'], array('role' => 'form', 'id'=>'topic-add'));?>
                            <div class="form-group">
                                <label for="title">标题</label>
                                <input type="text" class="form-control" id="title"  name="title" placeholder="标题" value="<?php echo $topic['title'];?>">
                            </div>
                            <div class="form-group">
