...
final class HtmlSanitizerTest extends CIUnitTestCase
{
    public function testRemovesScriptsDangerousLinksAndRemoteImages(): void
    {
        ...
        $clean = (new HtmlSanitizer())->clean('<script>alert(1)</script><a href="javascript:alert(1)">x</a><img src="https://evil.test/a.png"><img src="/uploads/editor/../../secret.png"><img src="' . $path . '">');
