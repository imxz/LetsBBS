...
$routes->post('media/images', 'Media::image');
...
$routes->get('settings/avatar', 'Member::settings', ['filter' => 'session']);
...
$routes->post('settings/avatar_do_upload', 'Member::avatar', ['filter' => 'session']);
...
$routes->get('logout', 'MethodNotAllowed::reject');
$routes->get('topic/(:num)/delete', 'MethodNotAllowed::reject');
$routes->get('topic/(:num)/follow', 'MethodNotAllowed::reject');
$routes->get('node/(:num)/follow', 'MethodNotAllowed::reject');
$routes->get('member/(:segment)/follow', 'MethodNotAllowed::reject');
$routes->get('update', 'MethodNotAllowed::gone');
$routes->get('static/editor/php/(.*)', 'MethodNotAllowed::gone');
$routes->get('install/testdb/(.*)', 'MethodNotAllowed::gone');
