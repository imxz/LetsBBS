    ...
    <section class="col-lg-8 admin-main">
        <div class="panel">
            <div class="panel-heading">
                <h1 class="panel-title">编辑主题</h1>
            </div>
            <div class="panel-body">
                <form method="post" action="/admin/topic/<?= (int) $topic['id'] ?>/edit">
                    <?= csrf_field() ?>
                    <div class="mb-3"><label class="form-label" for="title">标题</label><input class="form-control"
                            id="title" name="title" maxlength="160" value="<?= esc(old('title', $topic['title'])) ?>"
                            required></div>
